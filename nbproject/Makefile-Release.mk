...
${OBJECTDIR}/utils/math.o: utils/math.c
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/math.o utils/math.c

${OBJECTDIR}/utils/verbose.o: utils/verbose.c
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/verbose.o utils/verbose.c

${OBJECTDIR}/utils/weight_initializer.o: utils/weight_initializer.c
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/weight_initializer.o utils/weight_initializer.c
